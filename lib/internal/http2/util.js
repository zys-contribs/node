...
const IDX_OPTIONS_SESSION_LOCAL_WINDOW_SIZE = 9;
...
function updateOptionsBuffer(options) {
  ...
  if (typeof options.sessionLocalWindowSize === 'number') {
    flags |= (1 << IDX_OPTIONS_SESSION_LOCAL_WINDOW_SIZE);
    optionsBuffer[IDX_OPTIONS_SESSION_LOCAL_WINDOW_SIZE] =
      options.sessionLocalWindowSize;
  }
